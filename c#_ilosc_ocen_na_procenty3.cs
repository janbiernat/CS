...
/*--== % udział poszczególnych ocen w całkowitej ilości ocen 3 ==--
  Copyright (c)by Jan T. Biernat
*/
namespace OcenyNaProcent3
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("--== % udział poszczególnych ocen w całkowitej ilości ocen 3 ==--");
            ...
            for (int I = 0; I < 6; I++)
            {
                ...
                Console.Write(": ");
                Oceny[I] = 0;
                while(int.TryParse(Console.ReadLine(), out Oceny[I]) != true) {
