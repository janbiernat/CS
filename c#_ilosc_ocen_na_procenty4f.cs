...
/*--== % udział poszczególnych ocen w całkowitej ilości ocen 4f ==--
  Copyright (c)by Jan T. Biernat
*/
namespace OcenyNaProcent4f
{
    class Program
    {
        static int PodajLiczbe(int Nr = 0)
        {
            int L = 0;
            if(Nr > 0)
            {
                while (int.TryParse(Console.ReadLine(), out L) != true)
                {
        ...
        {
            Console.WriteLine("--== % udział poszczególnych ocen w całkowitej ilości ocen 4f ==--");
