...
/*--== % udział poszczególnych ocen w całkowitej ilości ocen 2 ==--
  Copyright (c)by Jan T. Biernat
*/
namespace OcenyNaProcent2
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("--== % udział poszczególnych ocen w całkowitej ilości ocen 2 ==--");
            ...
            for (int I = 0; I < 6; I++)
            {
                ...
                Console.Write(": ");
                Oceny[I] = 0;
                if(int.TryParse(Console.ReadLine(), out Oceny[I]) == false) { Oceny[I] = 0; }
